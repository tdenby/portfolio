...
hamburgerbutton.classList.add('notransition'); // Disable transitions
hamburgerbutton.offsetHeight; // Trigger a reflow, flushing the CSS changes
hamburgerbutton.classList.remove('notransition'); // Re-enable transitions
